                    ...
                    <div class="card-body">
                        ...
                        <div class="chat-input">
                            <div class="input-group">
                                ...
                                <button class="btn btn-outline-secondary" type="button" id="btn-kirim"><i
    ...
    <div class="modal fade" id="kuisModal" tabindex="-1" aria-labelledby="kuisModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" id="modalKuisBody">
                    <div>
                        Waktu yang disediakan untuk menjawab adalah <b>30 menit</b>, Kriteria Ketuntasan Minimal (KKM) yang harus
                        dicapai adalah <b>75</b>.
                    </div>
                    <div>
                        ...
                        <ul>
                            ...
                            <li>Setelah waktu habis, aplikasi akan otomatis menyimpan jawaban yang sudah diisi dan menutup
                                akses ke soal.</li>
                        </ul>
                    </div>
                </div>

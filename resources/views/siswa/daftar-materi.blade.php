        ...
        <div class="col-12">
            <div class="card materi-card">
                <div class="card-body ">
                    <div class="row">
                        <div class="col-12">
                            <a href="{{ route('siswa.materi', ['bab'=>0,'page'=>1]) }}" class="materi-title btn btn-color">Apersepsi</a>
                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="col-8 position-relative">
                            ...
                            @endif
                            <a href="{{ route('siswa.materi', ['bab'=>1,'page'=>1]) }}" class="materi-title btn btn-color">Konsep SPLDV</a>
                        ...
                        <div class="col-4 border-start position-relative">
                            ...
                            @endif
                            <a href="{{ route('siswa.kuis',['jenis'=>1]) }}" class="text">Kuis 1</a>
                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="col-8 position-relative">
                            ...
                            @endif
                            <a href="{{ route('siswa.materi', ['bab'=>2,'page'=>1]) }}" class="materi-title btn btn-color">Penyelesaian SPLDV</a>
                        ...
                        <div class="col-4 border-start position-relative">
                            ...
                            @endif
                            <a href="{{ route('siswa.kuis',['jenis'=>2]) }}" class="text">Kuis 2</a>
                            <small class="d-block fw-bold mt-2">Riwayat Nilai Kuis</small>
                            <div class="percobaan mt-2">
                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="col-8 position-relative">
                            ...
                            @endif
                            <a href="{{ route('siswa.materi', ['bab'=>3,'page'=>1]) }}" class="materi-title btn btn-color">Penerapan SPLDV</a>
                        ...
                        <div class="col-4 border-start position-relative">
                            ...
                            @endif
                            <a href="{{ route('siswa.kuis',['jenis'=>3]) }}" class="text">Kuis 3</a>
                            <small class="d-block fw-bold mt-2">Riwayat Nilai Kuis</small>
                            <div class="percobaan mt-2">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-5 position-relative">
                            ...
                            @endif
                            <a href="{{ route('siswa.kuis', ['jenis'=>4]) }}" class="materi-title btn btn-color">Evaluasi</a>
                        </div>

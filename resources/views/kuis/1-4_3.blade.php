Ubahlah pernyataan berikut ke dalam bentuk sistem persamaan linear dua variabel:
<ul>
    <li>Harga 2 ekor kelinci dikurang harga 2 ekor kucing adalah 30.000,00.</li>
    <li>Harga 3 ekor kelinci dan 5 ekor kucing adalah 450.000,00.</li>
</ul>
<div class="d-flex align-items-center justify-content-center gap-3">
    <div class="d-flex flex-column align-items-center">
        <img src="{{ asset('img/anjat-lukah.png') }}" alt="" height="200px">
        <small>Kelinci dan Kucing</small>
    </div>
</div>
